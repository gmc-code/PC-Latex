...
def get_perimeter_squares_dict(side_int=None, rotation=None):
    if side_int is None:
    ...
    calc_formula_value = 4
    calcperimeter_value = 4 * calc_sidelength
    units = "cm"
    ...
    kv["calcperimeter_value"] = f"{calcperimeter_value}"
    kv["calc_formula_value"] = f"{calc_formula_value}"
