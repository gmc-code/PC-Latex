...
tex_template_path = currfile_dir / "perimeter_squares_template.tex"
texans_template_path = currfile_dir / "perimeter_squares_template.tex"
tex_diagram_template_path = currfile_dir / "perimeter_squares_diagram_template.tex"
...
def make1_diagram(tex_diagram_template_txt,):
    ...
    kv = psf.get_perimeter_squares_dict()
...
def main():
    filename = input("Enter the base filename to be added to the prefix perimeter_squares_: \n")
    if not filename:
        filename = "1"  # "perimeter_squares_1_q and perimeter_squares_1_ans as default file"
    # set names of files that are made
    # questions
    tex_output_path = currfile_dir / f"perimeter_squares_{filename}_q.tex"
    pdf_path = currfile_dir / f"perimeter_squares_{filename}_q.pdf"
    png_path = currfile_dir / f"perimeter_squares_{filename}_q.png"

    # answers
    tex_output_path_ans = currfile_dir / f"perimeter_squares_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"perimeter_squares_{filename}_ans.pdf"
    png_path_ans = currfile_dir / f"perimeter_squares_{filename}_ans.png"
