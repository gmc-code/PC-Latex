  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=<<rotation>>]
        ...
        \draw[<->, gray]
            ...
            node[black, midway, fill=white, xshift=2mm, inner sep=3pt] {<<calc_sidelength>>\,\text{<<units>>}};
...
\begin{minipage}{.4\textwidth}
  \begin{align*}
  \text{Perimeter} &= 4l \\
  \text{Perimeter} &= <<calc_formula_value>> \times <<calcside_value>> \,\text{<<calc_units>>} \\
  \text{Perimeter} &= <<calcperimeter_value>> \,\text{<<calc_units>>}
  \end{align*}
\end{minipage}
