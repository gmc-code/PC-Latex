...
import area_triangles_right_functions as atf

currfile_dir = Path(__file__).parent
tex_template_path = currfile_dir / "area_triangles_right_template.tex"
texans_template_path = currfile_dir / "area_triangles_right_template.tex"
tex_diagram_template_path = currfile_dir / "area_triangles_right_diagram_template.tex"
...
tex_keys_q = ["calc_sidelength1", "calc_sidelength2", "sidelength1", "sidelength2", "rotation", "vA", "vB", "vC"]
...
def make1_diagram(
    ...
    kv = atf.get_area_triangles_right_dict()
...
def main():
    filename = input("Enter the base filename to be added to the prefix area_triangles_right_: \n")
    if not filename:
        filename = "1"  # "area_triangles_right_1_q and area_triangles_right_1_ans as default file"
    # set names of files that are made
    # questions
    tex_output_path = currfile_dir / f"area_triangles_right_{filename}_q.tex"
    pdf_path = currfile_dir / f"area_triangles_right_{filename}_q.pdf"
    png_path = currfile_dir / f"area_triangles_right_{filename}_q.png"

    # answers
    tex_output_path_ans = currfile_dir / f"area_triangles_right_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"area_triangles_right_{filename}_ans.pdf"
    png_path_ans = currfile_dir / f"area_triangles_right_{filename}_ans.png"
