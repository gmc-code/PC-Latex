...
tex_template_path = currfile_dir / "circumference_circles_template.tex"
texans_template_path = currfile_dir / "circumference_circles_template.tex"
tex_diagram_template_path = currfile_dir / "circumference_circles_diagram_template.tex"
...
def make1_diagram(tex_diagram_template_txt,):
    ...
    kv = ccf.get_circumference_circles_dict()
...
def main():
    filename = input("Enter the base filename to be added to the prefix circumference_circles_: \n")
    if not filename:
        filename = "1"  # "circumference_circles_1_q and circumference_circles_1_ans as default file"
    # set names of files that are made
    # questions
    tex_output_path = currfile_dir / f"circumference_circles_{filename}_q.tex"
    pdf_path = currfile_dir / f"circumference_circles_{filename}_q.pdf"
    png_path = currfile_dir / f"circumference_circles_{filename}_q.png"

    # answers
    tex_output_path_ans = currfile_dir / f"circumference_circles_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"circumference_circles_{filename}_ans.pdf"
    png_path_ans = currfile_dir / f"circumference_circles_{filename}_ans.png"
