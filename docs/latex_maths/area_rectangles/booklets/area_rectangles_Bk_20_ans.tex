  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        ...
        \draw (0,0) coordinate (K) --
              ++(2.006,0) coordinate (L) --
              ++(0,1.433) coordinate (M) --
              ++(-2.006,0) coordinate (N) -- cycle;
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=-30]
        ...
        \draw (0,0) coordinate (A) --
              ++(2.143,0) coordinate (B) --
              ++(0,1.607) coordinate (C) --
              ++(-2.143,0) coordinate (D) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        ...
        \draw (0,0) coordinate (K) --
              ++(2.67,0) coordinate (L) --
              ++(0,1.335) coordinate (M) --
              ++(-2.67,0) coordinate (N) -- cycle;
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        ...
        \draw (0,0) coordinate (W) --
              ++(1.717,0) coordinate (X) --
              ++(0,1.502) coordinate (Y) --
              ++(-1.717,0) coordinate (Z) -- cycle;
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=10]
        ...
        \draw (0,0) coordinate (E) --
              ++(2.991,0) coordinate (F) --
              ++(0,1.994) coordinate (G) --
              ++(-2.991,0) coordinate (H) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        ...
        \draw (0,0) coordinate (A) --
              ++(3.43,0) coordinate (B) --
              ++(0,1.715) coordinate (C) --
              ++(-3.43,0) coordinate (D) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=20]
        % Draw square
        \draw (0,0) coordinate (E) --
              ++(2.363,0) coordinate (F) --
              ++(0,1.969) coordinate (G) --
              ++(-2.363,0) coordinate (H) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        % Draw square
        \draw (0,0) coordinate (E) --
              ++(2.175,0) coordinate (F) --
              ++(0,1.864) coordinate (G) --
              ++(-2.175,0) coordinate (H) -- cycle;
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        ...
        \draw (0,0) coordinate (Q) --
              ++(2.988,0) coordinate (R) --
              ++(0,1.66) coordinate (S) --
              ++(-2.988,0) coordinate (T) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=-10]
        % Draw square
        \draw (0,0) coordinate (E) --
              ++(1.428,0) coordinate (F) --
              ++(0,1.269) coordinate (G) --
              ++(-1.428,0) coordinate (H) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=-20]
        % Draw square
        \draw (0,0) coordinate (E) --
              ++(1.564,0) coordinate (F) --
              ++(0,1.251) coordinate (G) --
              ++(-1.564,0) coordinate (H) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=-30]
        % Draw square
        \draw (0,0) coordinate (W) --
              ++(3.927,0) coordinate (X) --
              ++(0,1.571) coordinate (Y) --
              ++(-3.927,0) coordinate (Z) -- cycle;
...
\begin{minipage}{.4\textwidth}
  \begin{align*}
  \text{Area} &= lw \\
  \text{Area} &= 5 \,\text{cm} \times 2 \,\text{cm} \\
  \text{Area} &= 10 \,\text{cm}^2
  \end{align*}
\end{minipage}
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  \refstepcounter{minipagecount}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        % Draw square
        \draw (0,0) coordinate (K) --
              ++(3.926,0) coordinate (L) --
              ++(0,1.745) coordinate (M) --
              ++(-3.926,0) coordinate (N) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=10]
        % Draw square
        \draw (0,0) coordinate (K) --
              ++(2.704,0) coordinate (L) --
              ++(0,1.69) coordinate (M) --
              ++(-2.704,0) coordinate (N) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=-10]
        % Draw square
        \draw (0,0) coordinate (K) --
              ++(5.562,0) coordinate (L) --
              ++(0,1.236) coordinate (M) --
              ++(-5.562,0) coordinate (N) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        % Draw square
        \draw (0,0) coordinate (A) --
              ++(2.026,0) coordinate (B) --
              ++(0,1.351) coordinate (C) --
              ++(-2.026,0) coordinate (D) -- cycle;
        ...
        \draw[<->, gray]
            ($(A) + (0,-0.45cm)$) -- ($(B) + (0,-0.45cm)$)
            node[black, midway, fill=white, inner sep=3pt] {3\,cm};
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=30]
        % Draw square
        \draw (0,0) coordinate (A) --
              ++(5.967,0) coordinate (B) --
              ++(0,1.989) coordinate (C) --
              ++(-5.967,0) coordinate (D) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=30]
        % Draw square
        \draw (0,0) coordinate (W) --
              ++(2.402,0) coordinate (X) --
              ++(0,1.441) coordinate (Y) --
              ++(-2.402,0) coordinate (Z) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1, baseline=(current bounding box.north)]
    \begin{scope}[rotate=-20]
        % Draw square
        \draw (0,0) coordinate (A) --
              ++(2.494,0) coordinate (B) --
              ++(0,1.94) coordinate (C) --
              ++(-2.494,0) coordinate (D) -- cycle;
