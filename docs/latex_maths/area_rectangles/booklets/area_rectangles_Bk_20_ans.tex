  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        ...
        \draw (0,0) coordinate (W) --
              ++(8.0,0) coordinate (X) --
              ++(0,1.778) coordinate (Y) --
              ++(-8.0,0) coordinate (Z) -- cycle;
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=10]
        ...
        \draw (0,0) coordinate (E) --
              ++(6.231,0) coordinate (F) --
              ++(0,2.077) coordinate (G) --
              ++(-6.231,0) coordinate (H) -- cycle;
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        ...
        \draw (0,0) coordinate (K) --
              ++(3.065,0) coordinate (L) --
              ++(0,2.452) coordinate (M) --
              ++(-3.065,0) coordinate (N) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        % Draw square
        \draw (0,0) coordinate (E) --
              ++(3.312,0) coordinate (F) --
              ++(0,2.208) coordinate (G) --
              ++(-3.312,0) coordinate (H) -- cycle;
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        ...
        \draw (0,0) coordinate (A) --
              ++(3.662,0) coordinate (B) --
              ++(0,2.289) coordinate (C) --
              ++(-3.662,0) coordinate (D) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=-30]
        % Draw square
        \draw (0,0) coordinate (K) --
              ++(6.615,0) coordinate (L) --
              ++(0,1.89) coordinate (M) --
              ++(-6.615,0) coordinate (N) -- cycle;
...
\begin{minipage}{.4\textwidth}
  \begin{align*}
  \text{Area} &= lw \\
  \text{Area} &= 7 \,\text{cm} \times 2 \,\text{cm} \\
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=20]
        % Draw square
        \draw (0,0) coordinate (K) --
              ++(5.076,0) coordinate (L) --
              ++(0,2.256) coordinate (M) --
              ++(-5.076,0) coordinate (N) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        % Draw square
        \draw (0,0) coordinate (W) --
              ++(3.086,0) coordinate (X) --
              ++(0,2.204) coordinate (Y) --
              ++(-3.086,0) coordinate (Z) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=10]
        % Draw square
        \draw (0,0) coordinate (E) --
              ++(3.748,0) coordinate (F) --
              ++(0,1.874) coordinate (G) --
              ++(-3.748,0) coordinate (H) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=30]
        ...
        \draw (0,0) coordinate (E) --
              ++(2.69,0) coordinate (F) --
              ++(0,2.306) coordinate (G) --
              ++(-2.69,0) coordinate (H) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        % Draw square
        \draw (0,0) coordinate (A) --
              ++(3.469,0) coordinate (B) --
              ++(0,1.927) coordinate (C) --
              ++(-3.469,0) coordinate (D) -- cycle;
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        ...
        \draw (0,0) coordinate (Q) --
              ++(3.177,0) coordinate (R) --
              ++(0,2.471) coordinate (S) --
              ++(-3.177,0) coordinate (T) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=20]
        % Draw square
        \draw (0,0) coordinate (W) --
              ++(1.955,0) coordinate (X) --
              ++(0,1.738) coordinate (Y) --
              ++(-1.955,0) coordinate (Z) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=30]
        % Draw square
        \draw (0,0) coordinate (E) --
              ++(5.042,0) coordinate (F) --
              ++(0,2.161) coordinate (G) --
              ++(-5.042,0) coordinate (H) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        % Draw square
        \draw (0,0) coordinate (E) --
              ++(2.874,0) coordinate (F) --
              ++(0,1.916) coordinate (G) --
              ++(-2.874,0) coordinate (H) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=-30]
        % Draw square
        \draw (0,0) coordinate (W) --
              ++(5.467,0) coordinate (X) --
              ++(0,2.05) coordinate (Y) --
              ++(-5.467,0) coordinate (Z) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=-10]
        % Draw square
        \draw (0,0) coordinate (K) --
              ++(3.405,0) coordinate (L) --
              ++(0,1.946) coordinate (M) --
              ++(-3.405,0) coordinate (N) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=-20]
        ...
        \draw (0,0) coordinate (K) --
              ++(4.87,0) coordinate (L) --
              ++(0,2.435) coordinate (M) --
              ++(-4.87,0) coordinate (N) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        % Draw square
        \draw (0,0) coordinate (W) --
              ++(2.032,0) coordinate (X) --
              ++(0,1.693) coordinate (Y) --
              ++(-2.032,0) coordinate (Z) -- cycle;
...
\par\vspace{1cm}\begin{minipage}{0.55\textwidth}
  ...
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=0]
        % Draw square
        \draw (0,0) coordinate (K) --
              ++(2.121,0) coordinate (L) --
              ++(0,1.591) coordinate (M) --
              ++(-2.121,0) coordinate (N) -- cycle;
