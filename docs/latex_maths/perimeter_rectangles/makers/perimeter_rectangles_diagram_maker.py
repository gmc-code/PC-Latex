...
import perimeter_rectangles_functions as arf

currfile_dir = Path(__file__).parent
tex_template_path = currfile_dir / "perimeter_rectangles_template.tex"
texans_template_path = currfile_dir / "perimeter_rectangles_template.tex"
tex_diagram_template_path = currfile_dir / "perimeter_rectangles_diagram_template.tex"
...
#
# calcside_value1, calcside_value2, calcperimeter_value
...
def make1_diagram(
    ...
    kv = arf.get_perimeter_rectangles_dict()
...
def main():
    filename = input("Enter the base filename to be added to the prefix perimeter_rectangles_: \n")
    if not filename:
        filename = "1"  # "perimeter_rectangles_1_q and perimeter_rectangles_1_ans as default file"
    # set names of files that are made
    # questions
    tex_output_path = currfile_dir / f"perimeter_rectangles_{filename}_q.tex"
    pdf_path = currfile_dir / f"perimeter_rectangles_{filename}_q.pdf"
    png_path = currfile_dir / f"perimeter_rectangles_{filename}_q.png"

    # answers
    tex_output_path_ans = currfile_dir / f"perimeter_rectangles_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"perimeter_rectangles_{filename}_ans.pdf"
    png_path_ans = currfile_dir / f"perimeter_rectangles_{filename}_ans.png"
