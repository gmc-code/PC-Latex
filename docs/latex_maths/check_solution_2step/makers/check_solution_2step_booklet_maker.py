...
tex_template_path = currfile_dir / "check_solution_2step_booklet_template.tex"
texans_template_path = currfile_dir / "check_solution_2step_booklet_ans_template.tex"
tex_diagram_template_path = currfile_dir / "check_solution_2step_booklet_diagram_template.tex"
...
def main():
    ...
    #
    filename = input("Enter the base filename to be added to the prefix check_solution2_Bk_: \n")
    if not filename:
        filename = "1"  # "check_solution2_Bk_1_q and check_solution2_Bk_1_ans as default file"
    # set names of files that are made
    # questions
    tex_output_path = currfile_dir / f"check_solution2_Bk_{filename}_q.tex"
    pdf_path = currfile_dir / f"check_solution2_Bk_{filename}_q.pdf"
    aux_path = currfile_dir / "temp"
    # answers
    tex_output_path_ans = currfile_dir / f"check_solution2_Bk_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"check_solution2_Bk_{filename}_ans.pdf"
