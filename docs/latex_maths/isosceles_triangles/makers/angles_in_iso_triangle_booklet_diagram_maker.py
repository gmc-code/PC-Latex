...
tex_template_path = currfile_dir / "angles_in_iso_triangle_booklet_template.tex"
texans_template_path = currfile_dir / "angles_in_iso_triangle_booklet_ans_template.tex"
tex_diagram_template_path = currfile_dir / "angles_in_iso_triangle_booklet_diagram_template.tex"
...
def main():
    ...
    filename = input("Enter the base filename to be added to the prefix angles_in_iso_triangle_Bk_: \n")
    if not filename:
        filename = "1"  # "angles_in_iso_triangle_Bk_1_q and angles_in_iso_triangle_Bk_1_ans as default file"
    # set names of files that are made
    # questions
    tex_output_path = currfile_dir / f"angles_in_iso_triangle_Bk_{filename}_q.tex"
    pdf_path = currfile_dir / f"angles_in_iso_triangle_Bk_{filename}_q.pdf"

    # answers
    tex_output_path_ans = currfile_dir / f"angles_in_iso_triangle_Bk_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"angles_in_iso_triangle_Bk_{filename}_ans.pdf"
