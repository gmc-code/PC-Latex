...
tex_template_path = currfile_dir / "volume_rectangular_prisms_template.tex"
texans_template_path = currfile_dir / "volume_rectangular_prisms_template.tex"
tex_diagram_template_path = currfile_dir / "volume_rectangular_prisms_diagram_template.tex"
...
def make1_diagram(
    ...
    kv = arf.get_volume_rectangular_prisms_dict()
...
def main():
    filename = input("Enter the base filename to be added to the prefix volume_rectangular_prisms_: \n")
    if not filename:
        filename = "1"  # "volume_rectangular_prisms_1_q and volume_rectangular_prisms_1_ans as default file"
    # set names of files that are made
    # questions
    tex_output_path = currfile_dir / f"volume_rectangular_prisms_{filename}_q.tex"
    pdf_path = currfile_dir / f"volume_rectangular_prisms_{filename}_q.pdf"
    png_path = currfile_dir / f"volume_rectangular_prisms_{filename}_q.png"

    # answers
    tex_output_path_ans = currfile_dir / f"volume_rectangular_prisms_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"volume_rectangular_prisms_{filename}_ans.pdf"
    png_path_ans = currfile_dir / f"volume_rectangular_prisms_{filename}_ans.png"
