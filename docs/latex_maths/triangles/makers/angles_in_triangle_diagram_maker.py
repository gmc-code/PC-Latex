...
tex_template_path = currfile_dir / "angles_in_triangle_template.tex"
texans_template_path = currfile_dir / "angles_in_triangle_template.tex"
tex_diagram_template_path = currfile_dir / "angles_in_triangle_diagram_template.tex"
...
def main():
    ...
    # questions
    tex_output_path = currfile_dir / f"angles_in_triangle_{filename}_q.tex"
    pdf_path = currfile_dir / f"angles_in_triangle_{filename}_q.pdf"
    png_path = currfile_dir / f"angles_in_triangle_{filename}_q.png"

    # answers
    tex_output_path_ans = currfile_dir / f"angles_in_triangle_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"angles_in_triangle_{filename}_ans.pdf"
    png_path_ans = currfile_dir / f"angles_in_triangle_{filename}_ans.png"
