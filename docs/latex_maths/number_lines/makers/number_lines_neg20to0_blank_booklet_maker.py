...
tex_diagram_template_path = currfile_dir / "number_lines_neg20to0_blank_booklet_diagram_template.tex"
...
def main():
    ...
    if numq.strip().isdigit():
        ...
        numq = 16  # random by default
    #
    filename = input("Enter the base filename to be added to the prefix nlBk_blank_neg20to0_: \n")
    if not filename:
        filename = "1"
    # set names of files that are made
    tex_output_path = currfile_dir / f"nlBk_blank_neg20to0_{filename}.tex"
