...
tex_diagram_template_path = currfile_dir / "number_lines_0to20_booklet_diagram_template.tex"
...
def main():
    ...
    if numq.strip().isdigit():
        ...
        numq = 16  # random by default
    #
    filename = input("Enter the base filename to be added to the prefix nlBk_0to20_: \n")
    if not filename:
        filename = "1"  # "nlBk_1st_q and nlBk_1st_ans as default file"
    # set names of files that are made
    tex_output_path = currfile_dir / f"nlBk_0to20_{filename}_q.tex"
    pdf_path = currfile_dir / f"nlBk_0to20_{filename}_q.pdf"

    # answers
    tex_output_path_ans = currfile_dir / f"nlBk_0to20_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"nlBk_0to20_{filename}_ans.pdf"
