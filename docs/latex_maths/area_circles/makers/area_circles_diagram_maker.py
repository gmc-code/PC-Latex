...
tex_template_path = currfile_dir / "area_circles_template.tex"
texans_template_path = currfile_dir / "area_circles_template.tex"
tex_diagram_template_path = currfile_dir / "area_circles_diagram_template.tex"
...
def main():
    filename = input("Enter the base filename to be added to the prefix area_circles_: \n")
    if not filename:
        filename = "1"  # "area_circles_1_q and area_circles_1_ans as default file"
    # set names of files that are made
    # questions
    tex_output_path = currfile_dir / f"area_circles_{filename}_q.tex"
    pdf_path = currfile_dir / f"area_circles_{filename}_q.pdf"
    png_path = currfile_dir / f"area_circles_{filename}_q.png"

    # answers
    tex_output_path_ans = currfile_dir / f"area_circles_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"area_circles_{filename}_ans.pdf"
    png_path_ans = currfile_dir / f"area_circles_{filename}_ans.png"
