...
tex_template_path = currfile_dir / "area_squares_template.tex"
texans_template_path = currfile_dir / "area_squares_template.tex"
tex_diagram_template_path = currfile_dir / "area_squares_diagram_template.tex"
...
def main():
    filename = input("Enter the base filename to be added to the prefix area_squares_: \n")
    if not filename:
        filename = "1"  # "area_squares_1_q and area_squares_1_ans as default file"
    # set names of files that are made
    # questions
    tex_output_path = currfile_dir / f"area_squares_{filename}_q.tex"
    pdf_path = currfile_dir / f"area_squares_{filename}_q.pdf"
    png_path = currfile_dir / f"area_squares_{filename}_q.png"

    # answers
    tex_output_path_ans = currfile_dir / f"area_squares_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"area_squares_{filename}_ans.pdf"
    png_path_ans = currfile_dir / f"area_squares_{filename}_ans.png"
