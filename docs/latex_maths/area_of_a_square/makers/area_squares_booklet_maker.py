...
side_ints_list = asf.get_ints_shuffled_one_dig_first()
...
def make1_diagram(tex_diagram_template_txt, side_int, rotation):
    ...
    kv = asf.get_area_squares_dict(side_int, rotation)
...
def main():
    ...
    filename = input(
        "Enter the base filename to be added to the prefix area_squares_Bk_: \n"
    )
    if not filename:
