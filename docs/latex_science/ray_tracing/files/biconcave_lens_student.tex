...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \begin{scope}[shift={(current page.center)}, x=1cm, y=1cm, >=Stealth]
    ...
    % centre 6mm lensXC =3mm, sagitta 6mm lensXR 5.7; End has + 0.1 to improve look
    ...
    \draw[fill=black] (Fv) circle (0.07) node[below=22mm, xshift=-1.8cm] {\Large \makebox[3.5cm][l]{\dotfill}};
