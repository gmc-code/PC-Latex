...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \begin{scope}[shift={(current page.center)}, x=1cm, y=1cm, >=Stealth]
    ...
    % PARAMETERS
    % lens height57mm, half height lensYR; width from 3 to 15 mm
    % centre 3mm lensXC=1.5mm approx, sagitta 6mm lensXR 5.7
    ...
    \foreach \y in {- \dy, 0, \dy} {
      ...
      \draw[gray, thick] (-6,\y) -- (0.2-\lensXCS,\y);
    }

    \foreach \y in {- \rdy, 0, \rdy} {
      \pgfmathsetmacro{\yend}{\y*(1 - \rayEnd/\f)}
      \draw[gray, thick] (-0.2+\lensXCS,\y) -- (F);
